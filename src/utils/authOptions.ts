    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        try {
          ...
          const errorMessage = e?.message || e?.response?.data?.message || 'Something went wrong in /login - authOptions!';
    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        try {
          ...
          console.error(e);
          const errorMessage = e?.message || e?.response?.data?.message || 'Something went wrong in /register - authOptions!';
          throw new Error(errorMessage);
        }
      }
    })
